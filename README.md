...
sudo podman run -v $PWD/ownership_vouchers:/etc/fdo/ownership_vouchers -v $PWD/keys:/etc/fdo/keys -v $PWD/config/owner-onboarding-server.yml:/etc/fdo/owner-onboarding-server.yml -p 0.0.0.0:8081:8081 localhost/fdo-owner-onboarding-server
